...
//forEach executes a provided function once for each array, while a map creates a new array and uses return values and actually returns a new array.
...
5. Why do we need super() in an extended class?
   //super() is used to form a connection between a parent’s constructor and a child’s attributes. It abstracts away the Object.create(this, Class) syntax and is required for classes to make this connection
